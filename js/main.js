function createJsonFile(object, linkId, pos) {
    ...
    $('<a style="position: fixed;top: ' + pos + 'px;z-index: 100000;" href="#" id="' + linkId +'" download="' + linkId + '.json">Download ' + linkId + ' as JSON</a>').appendTo("body");
